    ...
    <section className="relative py-20 bg-black text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="mt-16 bg-white/10 backdrop-blur-lg p-8 rounded-xl border border-white/20 shadow-lg"
        >
          <h2 className="text-3xl font-bold text-white">
            Join Us for the <span className="text-indigo-400">Opportunity</span>, Stay for the <span className="text-indigo-400">Growth</span>
          </h2>
          <p className="text-lg text-gray-300 mt-4">
            At GramTarang Technologies, our brightest minds solve tomorrow’s challenges. Contribute your expertise to the industry’s most forward-thinking team to reshape information, communication, and innovation around the globe. Develop your skills and expand your opportunities with access to the industry's leading talent, training, and technology.
          </p>
        </motion.div>
